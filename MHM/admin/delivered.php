        ...
        <div class="container-fluid">
          <ol class="breadcrumb"> 
            <li class="breadcrumb-item">
              <a href="delivered.php"><b>Delivered Orders</b></a>
            </li>
...
<?php
           while($row=mysqli_fetch_array($data))
              ...
              echo "<td><button type='button' class='btn btn-primary btn-sm'><a href='adminPaymentdetails.php?payment_id=".$row['payment_id']."' style='color:white'><i class='fa fa-eye'></i> View Payment Details</a></button></td>";
