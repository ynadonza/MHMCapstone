          ...
          <div id ="box2">
                ...
                ?>             
                    <p style="color:red">* Required Fields </p>
                        <form method="POST" action="insertProducts.php" onsubmit="return validateProducts()" enctype="multipart/form-data"> 
                            ...
                            <div>
                                ...
                                <input type="text" name="prod_name" placeholder="Product Name" id="prod_id" autocomplete="off"><br>
                                <span id="prod_error" class="text-danger font-weight-bold"></span><br>
                            </div>  

                            <div>
                                 <b>Quantity</b><span class="required">*</span><br>
                                <input type="text" name="qty" placeholder="Quantity" id="qty_id" autocomplete="off"><br>
                                <span id="qty_error" class="text-danger font-weight-bold"></span><br>
                            </div>

                            <div>
                                 <b>Market Price</b><span class="required">*</span><br>
                                <input type="text" name="unit_price" placeholder="Market Price Per Unit" id="unit_id" autocomplete="off"><br>
