...
$query = "SELECT * FROM users JOIN address ON users.add_id = address.add_id WHERE user_id = '{$_GET['user_id']}' ";
       ...
       <center>
         <div id = "box">            
                <p style="color:red">* Required Fields </p>
                  <form method="POST" onsubmit="return validate()" action="updateEmployee.php?">
                    <div class="container-fluid">
                        <div class="row">
                        <div class="col-md-6">  
                        <div class="form-group">
                            <input type="text" name="user_id" hidden value="<?php echo $_GET['user_id']; ?>">
                            
                            <label for="fname"><b>First Name</b><span class="required">*</span></label> <br> 
                            <input type="text" placeholder="Enter First Name" id="fname_id" name="fname" size="50" class="form-control" value="<?php echo $data['fname']; ?>"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Middle Name" id="mname_id" name="mname" size="50" class="form-control" value="<?php echo $data['mname']; ?>"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Last Name" id="lname_id" name="lname" size="50" class="form-control" value="<?php echo $data['lname']; ?>"> 
                            <span id="lname_error" class="text-danger font-weight-bold"></span>
                        </div>
                        <div class="form-group">
                            <label for="email"><b>Email</b><span class="required">*</span></label> <br>
                            <input type="text" placeholder="Enter Email" id="email_id" name="email" size="50" class="form-control" value="<?php echo $data['email']; ?>" readonly> 
                      ...
                      <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Username" id="username_id" name="username" size="50" class="form-control" value="<?php echo $data['username']; ?>"> 
                         ...
                         <div class="form-group">   
                            ...
                            <input type="text" id="contact_id" name="contact" placeholder="Contact" size="50" class="form-control" value="<?php echo $data['contact']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="street_id" name="street" placeholder="Street" size="50" class="form-control" value="<?php echo $data['street']; ?>"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="brgy_id" name="brgy" placeholder="Barangay" size="50" class="form-control" value="<?php echo $data['brgy']; ?>"> 
                            <span id="brgy_error" class="text-danger font-weight-bold"></span>
                        </div>
                      
                       <div class="form-group">
                              <label for="city"><b>City</b><span class="required">*</span></label> <br>
                              <input type="text" id="city_id" size="50" name="city" placeholder="City" class="form-control" value="<?php echo $data['city']; ?>"> 
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" id="province_id" size="50" name="province" placeholder="Province" class="form-control" value="<?php echo $data['province']; ?>">
                              <span id="province_error" class="text-danger font-weight-bold"></span> 
                          </div>
                        <div class="form-group">
                        
                          <label for="zip"><b>Zip</b><span class="required">*</span></label> <br>
                          <input type="text" id="zip_id" name="zip" placeholder="Zip Code"  pattern=".{4,}" class="form-control" value="<?php echo $data['zip_code']; ?>"> 
                         ...
                         <button type="submit" value="submit" name="submit" class="btn btn-success">Edit Employee</button> 
