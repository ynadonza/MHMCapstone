<?php 
  require("../database/sql_connect.php");
        ...
        $query = "SELECT * FROM orders
                  ...
                  WHERE orderStatus = 'For Delivery' ORDER BY orders.order_id DESC";
   ...
   <div id="content-wrapper">
        <div class="container-fluid">
          <ol class="breadcrumb"> 
            ...
            <li class="breadcrumb-item active">For Delivery Orders
            </li>
          </ol>
        </div>
<!-- TABLE -->
<center><h1>For Delivery Orders</h1></center>
<div id="page-inner"> 
    <div class="row">
       <div class="col-md-12">
...
<?php
           while($row=mysqli_fetch_array($data))
             ...
             if($row['orderStatus'] == 'For Delivery'){
                echo "<td><button type='button' class='btn btn-primary btn-sm active'><a href='updateStatusdelivered.php?order_id=".$row['order_id']."' style='color:white' onClick=\"return confirm('Proceed to delivered?')\"><i class='fa fa-car'> {$row['orderStatus']}</a></button></td>";
              }
              echo "</tr>";
             }
