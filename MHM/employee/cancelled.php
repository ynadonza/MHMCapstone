<?php 
  require("../database/sql_connect.php");
        ...
        $query = "SELECT * FROM orders
                  ...
                  WHERE orderStatus = 'Cancelled' ORDER BY orders.order_id DESC ";
   ...
   <div id="content-wrapper">
        <div class="container-fluid">
          <ol class="breadcrumb"> 
           ...
           <li class="breadcrumb-item active">Cancelled Orders
            </li>
          </ol>
        </div>
<!-- TABLE -->
...
<div id="page-inner"> 
    <div class="row">
       <div class="col-md-12">
            <div class='panel panel-success' style='width:800px;margin:5% auto;'>
...
<?php
           while($row=mysqli_fetch_array($data))
              ...
              echo "<td><button class='btn btn-danger btn-sm'><i class='fa fa'> {$row['orderStatus']}</td>";
              echo "</tr>";
             }
