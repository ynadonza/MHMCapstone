    ...
    <div class="row">
        <div class="col-xs-12">
    		<div class="invoice-title">
    			...
    			<h2>Invoice</h2><h3 class="pull-right">Order #: <?php echo "<span>".date("Y").$rows['order_id']."</span>"; ?></h3>
    			</div>
    		</div>
    		<hr>
    		<div class="row">
    			...
    			<div class="col-xs-6 text-right">
    				...
    				<address>
    					...
    					<?php 
                            $date = date("F d, Y",strtotime($rows['order_date']));
                            echo $date;
                         ?>
                         <br><br>
    				</address>
    				...
    				<div class="table-responsive">
    					<table class="table table-condensed">
    						...
    						<tbody>
                                ...
                                $photo = $rows['photo'];
                                    ...
                                    echo "<td class='text-center'>".$rows['prod_name']."</td>";
                                    $selling_price = number_format($rows['selling_price'],2); 
                                    echo "<td class='text-center'>".$selling_price."</td>"; 
    					...
    					<div style="float:right">
                                ...
                                $query = "SELECT * FROM orders WHERE order_id = ('$order_id')";
                                 ...
                                 echo "<a href='userpayment.php?order_id=".$row['order_id']."'><button class='btn btn-primary'><i class='fa fa-credit-card'></i> Proceed to Payment</button></a>";
                                 }else if($row['paymentStatus'] == 'paid'){
                                    echo "<button class='btn btn-success'><i class='fa fa-check'></i> Payment process is already been done</button>";
                                 }
